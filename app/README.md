...
The app inserts the repo root on `sys.path` for `scripts` imports when you run the file directly; editable install is still recommended for tests and `python -m scripts.main`.
